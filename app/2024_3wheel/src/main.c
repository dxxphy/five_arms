...
void console_feedback(void *arg1, void *arg2, void *arg3)
{
	while (1) {
		...
		float accel_x =
			((float)accel_data[0].val1 + (float)accel_data[0].val2 / 1000000.0f);
		float accel_y =
			((float)accel_data[1].val1 + (float)accel_data[1].val2 / 1000000.0f);
		float accel_z =
			((float)accel_data[2].val1 + (float)accel_data[2].val2 / 1000000.0f);
