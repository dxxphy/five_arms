...
chassis_driver_api_area : SUBALIGN(4) { _chassis_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._chassis_driver_api.static.*))); _chassis_driver_api_list_end = .; } > FLASH
motor_driver_api_area : SUBALIGN(4) { _motor_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._motor_driver_api.static.*))); _motor_driver_api_list_end = .; } > FLASH
sbus_driver_api_area : SUBALIGN(4) { _sbus_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._sbus_driver_api.static.*))); _sbus_driver_api_list_end = .; } > FLASH
wheel_driver_api_area : SUBALIGN(4) { _wheel_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._wheel_driver_api.static.*))); _wheel_driver_api_list_end = .; } > FLASH
