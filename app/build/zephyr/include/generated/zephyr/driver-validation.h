...
#define K_SYSCALL_DRIVER_CHASSIS(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, chassis, CHASSIS)

#define K_SYSCALL_DRIVER_MOTOR(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, motor, MOTOR)

#define K_SYSCALL_DRIVER_SBUS(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, sbus, SBUS)

#define K_SYSCALL_DRIVER_WHEEL(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, wheel, WHEEL)
